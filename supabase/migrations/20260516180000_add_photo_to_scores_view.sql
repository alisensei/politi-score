-- ============================================================
-- Ajoute les colonnes manquantes à scores_computed :
--   - photo_url      (utilisée par PoliticianCard / Modal)
--   - mandate_start / mandate_end / created_at / updated_at
-- Sans ces colonnes, le frontend reçoit `photo_url: undefined`
-- et tombe sur les initiales de fallback.
-- ============================================================
